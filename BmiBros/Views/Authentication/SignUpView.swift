...
//                BUTTON
                VStack {
                    ...
                    } .disabled(username.isEmpty || email.isEmpty || password.isEmpty) // Mengatur tombol menjadi nonaktif jika username, email, atau password kosong
                    .opacity(username.isEmpty || email.isEmpty || password.isEmpty ? 0.5 : 1) // Mengatur opasitas tombol
